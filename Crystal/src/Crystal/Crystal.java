...
import Crystal.Command.Player_Command;
...
public class Crystal extends JavaPlugin {
    ...
    public Set warp_list = data.getKeys(false);
    ...
    public void onEnable() {
        ...
        inventory();
        registerEvents();
        System.out.print(warp_list.size());
        setup();
    }

    public void getCommandExecutor() {
        this.getCommand("tc").setExecutor(new Player_Command(this));
        this.getCommand("test").setExecutor(new Player_Command(this));
    }

    public void registerEvents() {
        this.getServer().getPluginManager().registerEvents(new Item_Listener(this), this);
    }
    ...
    public static void setup() {
        for (int i = 0; i < data.getKeys(false).size(); i++) {
            ...
            Player_Command.addMaterial(type, i, name, lore);
        }
    }
}